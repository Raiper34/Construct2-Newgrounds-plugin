...
{
	return {
		"name":			"Newgrounds API",				// as appears in 'insert object' dialog, can be changed as long as "id" stays the same
		"id":			"NewgroundsAPI",				// this is used to identify this plugin and is saved to the project; never change it
